# Vendored Opus 1.3.1 (BSD, xiph.org) - fixed-point decoder+encoder, portable C only.
# Generated; see third_party/opus/COPYING.
OPUS_DIR = $$PWD/third_party/opus
INCLUDEPATH += \
    $$OPUS_DIR/include \
    $$OPUS_DIR \
    $$OPUS_DIR/celt \
...
DEFINES += OPUS_BUILD FIXED_POINT VAR_ARRAYS
